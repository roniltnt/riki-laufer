    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-10 text-right mb-10">
      ...
      <div>
        <div class="flex items-center justify-end gap-3 mb-4">
          ...
          <img src="${data.logo}" alt="לוגו ריקי"
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm">
          <li>
            <a href="tel:${data.contact.phone_tel}" class="flex items-center justify-end gap-3 hover:text-plum-400 transition-colors">
              <span dir="ltr">${data.contact.phone_display}</span><i class="fas fa-phone text-plum-500 w-4"></i>
            </a>
          </li>
          <li>
            <a href="mailto:${data.contact.email}" class="flex items-center justify-end gap-3 hover:text-plum-400 transition-colors">
              <span>${data.contact.email}</span><i class="fas fa-envelope text-plum-500 w-4"></i>
            </a>
          </li>
          <li>
            <a href="https://wa.me/${data.contact.whatsapp_number}" target="_blank" rel="noopener noreferrer" class="flex items-center justify-end gap-3 hover:text-plum-400 transition-colors">
